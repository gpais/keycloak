...
@EnableZuulProxy
public class GatewayuaaApp {

    private static final Logger log = LoggerFactory.getLogger(GatewayuaaApp.class);

    private final Environment env;

    public GatewayuaaApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes gatewayuaa.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(GatewayuaaApp.class);
